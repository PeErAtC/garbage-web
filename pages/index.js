...
function LoginPage(props) {
    ...
    const handleLogin = () => {
        ...
        if ((idNumber === 'admin' && password === '1234') || 
            (idNumber === 'user' && password === 'abcd') ||
            (idNumber === 'manager' && password === '1234')) {

            if (idNumber === 'admin') {
                router.push("/homepage");
            } else if (idNumber === 'user') {
                router.push("/homepage");
            } else if (idNumber === 'manager') {
                router.push("/mainmanager");
            }
            const successMessage = `เข้าสู่ระบบสำเร็จ`;
