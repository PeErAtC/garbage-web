...
import { AiOutlineHome, AiOutlineInbox } from 'react-icons/ai'; // Import Icons from Ant Design
      ...
      <div className="sidebar h-full">
        ...
        <div className="menu h-full lg:h-full">
          <ul>
            ...
            <Link href="/ManagerExpensesSummary">
              <button onClick={() => handleMenuClick('สรุปการชำระค่าขยะ')} className={selectedMenu === 'สรุปการชำระค่าขยะ' ? 'active' : ''}>
                <AiOutlineInbox size={24} />
                <span className="menu-text">สรุปการชำระค่าขยะ</span>
              </button>
            </Link>
          </ul>
        </div>
          ...
          <div className="modal">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <h2>ตั้งค่า</h2>
                <Link href="/ManagerResetpassword">
                  <button
...
const DashboardNoTotal = () => {
  return (
    <div>
      <Sidebar username="สวัสดี ผู้บริหาร" />
    </div>
  );
};

export default DashboardNoTotal;
